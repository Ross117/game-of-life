...
describe('activeNodesAdjacent', () => {
    ...
    it('returns Array(8) when [1,1] passed in', () => {
        expect(validAdjacentNodes([1,1])).toEqual([[0, 0], [1,0], [2,0], [0,1], [2,1], [0,2], [1,2], [2,2]]);
    })

    it('returns Array(8) when [2,2] passed in', () => {
        expect(validAdjacentNodes([2,2])).toEqual([[1, 1], [2,1], [1,2]]);
    })
});
